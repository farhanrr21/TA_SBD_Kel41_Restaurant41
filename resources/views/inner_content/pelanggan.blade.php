<main>
    <div class="py-10">
        ...
        <div class="container max-w-7xl mx-auto mt-8">
            <div class="mb-4">
                <h1 class="text-3xl font-bold underline decoration-gray-400 mb-6">Database Pelanggan</h1>
                <div class="flex justify-between">
                    <form method="POST" action="{{route('pelanggan.searchData', "pelanggan")}}">
                        @csrf
                    ...
                    <a href="{{route('addData.pelanggan')}}" type="button" class="flex items-center px-4 py-2 rounded-md bg-sky-500 align-middle text-white hover:bg-sky-600">Tambah Data</a>
                </div>
            </div>
                                ...
                                @foreach($data_pelanggan as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                                            <a href="{{route('editData.pelanggan', $data->id_pelanggan)}}" class="text-indigo-600 hover:text-indigo-900">
                                        ...
                                        <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                            <a href="{{route('soft.pelanggan', $data->id_pelanggan)}}"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-yellow-600 hover:text-yellow-800"
